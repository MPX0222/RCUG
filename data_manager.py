...
class DataManager(object):
    def __init__(self, config, logger):
        ...
        elif config.dataset_name == "Skin8":
            self.data = Skin8(shuffle=config.data_shuffle, img_size=config.img_size)
        elif config.dataset_name == "MedMNIST":
            self.data = MedMNIST(shuffle=config.data_shuffle, img_size=config.img_size)
